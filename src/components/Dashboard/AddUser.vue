<template>
  <div>
    <h3>{{is_edit?'update User':'Add User'}}</h3>

    <form @submit="onSubmit" id="form" class="row g-3 needs-validation" novalidate>
      <div class="col-md-4">
        <label for="name" class="form-label">Name</label>
        <input type="text" class="form-control" placeholder="Enter Name" id="name" v-model="user.name" required />
      ...
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" placeholder="Enter City" id="city" v-model="user.city" />
        <div class="invalid-feedback">Enter city.</div>
      </div>

      <div class="col-md-4">
        <label for="address" class="form-label">Address</label>
        <textarea type="date" class="form-control" placeholder="Enter Full address" id="address" v-model="user.address">
        </textarea>
      </div>
      ...
      <div class="col-md-4">
        ...
        <select class="form-select" id="country" v-model="user.country">
          ...
          <option :key="item.code" v-for="item in country_list" :value=item.name>{{item.name}}</option>
        </select>
      ...
      <div class="col-md-3">
        ...
        <select multiple class="form-select" id="skill" v-model="user.skills">
          <option selected disabled hidden value="">Choose Mutiple.</option>
          <option value="frontend">Front End</option>
          <option value="backend">Back End</option>
          <option value="fullstack">Full Stack</option>
        </select>
        <div class="text-sm">(Use ctrl or cmd to select multiple).</div>
      </div>

      <div class="col-12">
        <button class="btn btn-primary" type="submit">{{is_edit?'Update':'Add New'}}</button>
      </div>
    </form>
  </div>
...
export default {
  ...
  methods: {
    ...
    isFormValid() {
      ...
      if (!this.isVarExist(this.user.name)) {
